...
function HomePage() {
  ...
  let copyToClipboard = async (text) => {
    try {
      ...
      console.log(
        `This error occured in copying the URL to the clipboard : ${e}`,
      );
    }
  };
      ...
      <div className="main-content">
        <div className="content-wrapper">
          ...
          <div className="buttons-container">
            <button
              className="meeting-button start-meeting"
            ...
            >
              <div className="button-icon">
                ...
                >
                  <path
                    d="M15 10L19.553 7.724C20.3597 7.32 21 7.82 21 8.724V15.276C21 16.18 20.3597 16.68 19.553 16.276L15 14M5 18H13C14.1046 18 15 17.1046 15 16V8C15 6.89543 14.1046 6 13 6H5C3.89543 6 3 6.89543 3 8V16C3 17.1046 3.89543 18 5 18Z"
                    stroke="currentColor"
                    strokeWidth="2"
                    strokeLinecap="round"
            ...
            <button
              className="meeting-button join-meeting"
